...
parser = argparse.ArgumentParser(formatter_class=argparse.RawDescriptionHelpFormatter, description=textwrap.dedent('''\
    ...
    patches from TeamEOS's Gerrit instance.
...
if args.topic:
    url = 'http://review.teameos.org/changes/?q=topic:%s' % args.topic
    if args.verbose:
...
for change in args.change_number:
    ...
    #   )]}'
    #   [ ... valid JSON ... ]
    url = 'http://review.teameos.org/changes/?q=%s&o=CURRENT_REVISION&o=CURRENT_COMMIT&pp=0' % change
    if args.verbose:
